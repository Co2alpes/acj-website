...
const styles = StyleSheet.create({
  ...
  // --- MODIFICATION ICI : Taille réduite (12) et marges ajustées ---
  docTitle: { fontSize: 12, fontWeight: 'bold', marginBottom: 10, textAlign: 'right', width:'100%', color: '#000' },
...
const DocumentPDF = ({ type, chantier, materiaux = [], reports = [], total = 0 }) => {
  ...
  // Titre en minuscules sauf la première lettre
